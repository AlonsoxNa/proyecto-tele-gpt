...
import { Alert, Backdrop, Container, Grid, IconButton, Snackbar, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material';
...
const GestionCategoria = () => {
    ...
    const handleModificarCategoria = (id:string) => {
        navigate('/admin/modificar-categoria',{state:{id:id}})
    }
            ...
            <TableBody>
                ...
                >
                    ...
                    <Stack direction="row" spacing={ 1 }>
                        ...
                        <IconButton onClick={ () => handleModificarCategoria( row.id) } sx={ { width: 'auto', backgroundColor: '#c6def5' } } color="primary"> <ModeEditIcon /> </IconButton>
                    </Stack>
                    </TableCell>
