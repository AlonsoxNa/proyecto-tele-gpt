  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-center align-items-center gap-4 vh-100">
        <Link className="btn btn-primary" to="/crear-anuncio">Ir a crear noticia</Link>
        <Link className="btn btn-primary" to="/slider" >Ir a slider</Link>
        <Link className="btn btn-primary" to="/admin/noticias" >Ir a Configurar noticias</Link>
      </div>
    </>
  );
};